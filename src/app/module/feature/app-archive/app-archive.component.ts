...
export class AppArchiveComponent implements OnInit, OnDestroy {

  displayedColumns: string[] = ['select', 'date', 'sender', 'subject'];
  dataSource;
  ...
  ngOnInit() {
    this.emailService.getArchivedEmails().subscribe(res => {
